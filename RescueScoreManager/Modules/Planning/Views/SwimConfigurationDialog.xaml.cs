...
{
    public partial class SwimConfigurationDialog : Window
    {
        public SwimConfigurationDialog()
        {
            InitializeComponent();
        }

        public SwimConfigurationDialog(string title) : this()
        {
            Title = title;
        }

        public SwimConfigurationDialog(string title, List<Race> races) : this()
        {
            Title = title;
