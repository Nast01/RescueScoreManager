...
{
    public partial class BeachConfigurationDialog : Window
    {
        public BeachConfigurationDialog()
        {
            InitializeComponent();
        }

        public BeachConfigurationDialog(string title) : this()
        {
            Title = title;
        }

        public BeachConfigurationDialog(string title, List<Race> races) : this()
        {
            Title = title;
        ...
        private void InitializeViewModel(List<Race> races)
        {
            try
            {
                ...
                {
                    BeachConfigurationDialogViewModel viewModel = new BeachConfigurationDialogViewModel(localizationService, xmlService, apiService, authService, messenger, races);
